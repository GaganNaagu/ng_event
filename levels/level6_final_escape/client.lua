-- levels/level6_final_escape/client.lua
-- Client logic for Final Escape
...
function Level6.SetupZones()
        ...
        Target.AddLocalEntity(ent, {
            {
                ...
                canInteract = function()
                    return LocalEventState and LocalEventState.level == 6 and LocalEventState.tokens[5]
                end
            }
        })
    ...
    TriggerEvent("ng_event:client:ShowLevel6Blip")
end
...
RegisterNetEvent("ng_event:client:ShowLevel6Blip", function()
    ...
    if bridgeCoords then
        ...
        SetBlipSprite(level6Blip_Bridge, 126) 
        SetBlipColour(level6Blip_Bridge, 2) 
