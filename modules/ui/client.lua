...
function RefreshUI()
    ...
    local lvl = LocalEventState and LocalEventState.level or 1
    ...
    local extraInfo = nil
    if lvl == 2 then
        extraInfo = string.format("Kills: %d/%d", LocalEventState and LocalEventState.arenaKills or 0, Config.Levels[2].killsRequired)
    elseif lvl == 5 then
